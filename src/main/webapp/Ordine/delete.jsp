			  		...
			  		<div class='card'>
					    ...
					    <div class='card-body'>
					    	<dl class="row">
							  ...
							  <dd class="col-sm-9"><c:out value="${ordineInPagina.codice}"/></dd>
					    	</dl>
					    	...
					    	<dl class="row">
							  ...
							  <dd class="col-sm-9"><c:out value="${ordineInPagina.costoTotaleOrdine}"/></dd>
					    	</dl>
					    	
					    	<dl class="row">
							  <dt class="col-sm-3 text-right">Cliente:</dt>
							  <dd class="col-sm-9"><c:out value="${ordineInPagina.cliente.nome}"/> <c:out value="${ordineInPagina.cliente.cognome}"/> </dd>
					    	</dl>
					    	
					    	<dl class="row">
							  <dt class="col-sm-3 text-right">Fattorino:</dt>
							  <dd class="col-sm-9"><c:out value="${ordineInPagina.utente.nome}"/> <c:out value="${ordineInPagina.utente.cognome}"/> </dd>
					    	</dl>
					    ...
					    <div class='card-footer'>
					        ...
					        <form method="post" action="ExecuteDeleteOrdineServlet">

			  ...
			  <div class="container">
			     ...
			     <div class="p-5 mb-4 bg-light rounded-3">
				      <div class="container-fluid py-5">
				        <h1 class="display-5 fw-bold">Benvenuto a Pizza Sore</h1>
				        ...
				        <a class="btn btn-primary btn-lg" href="ExecuteListClienteServlet">Vai a Ricerca Clienti </a>
				      </div>
			    </div>
			  ...
			  <div class="container px-4 py-5" id="featured-3">
			    <div class="row g-4 py-5 row-cols-1 row-cols-lg-3">
			      <div class="feature col">
			        ...
			        <a href="ExecuteListClienteServlet" class="icon-link">

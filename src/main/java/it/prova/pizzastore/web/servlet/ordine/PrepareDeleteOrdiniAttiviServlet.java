...
@WebServlet("/PrepareDeleteOrdiniAttiviServlet")
public class PrepareDeleteOrdiniAttiviServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("/Ordine/deleteOrdiniAttivi.jsp").forward(request, response);
	}
